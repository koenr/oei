...
<br>
	...
	<tr id="rij<?php echo $nr;?>" class="tabelrij">
		...
		<td width=""  align="center"><input  type="text" size="2"  name="foutnr_<?php echo $nr;?>" id="foutnr_<?php echo $nr;?>" value="<?php echo $fout->geefFoutnr(); ?>" onkeyup="foutOmschrijvingOphalen(this.value,this.name);setVerantwoordingnr(<?php echo $nr; ?>);" onclick = "foutOmschrijvingOphalen(this.value,this.name);setVerantwoordingnr(<?php echo $nr; ?>);" /></td>
		<td width="" align="center"><input type="text" size="26" name="fout_<?php echo $nr;?>" value="<?php echo $fout->geefFout(); ?>"/></td>
		<td width="" align="center"><input type="text" size="26" name="verbetering_<?php echo $nr;?>" value="<?php echo $fout->geefVerbetering(); ?>"/></td>
		<td width="" align="center"><input type="text" size="75" name="verantwoording_<?php echo $nr;?>" id="verantwoording_<?php echo $nr;?>" value="<?php echo $fout->geefVerantwoording(); ?>" />&nbsp;</td>
		<td align="center">
